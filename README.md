...
## Variantes (nomenclatura sugerida)
- EsperanzaSans-Regular.otf
- EsperanzaSans-Bold.otf
- EsperanzaSans-Italic.otf
- EsperanzaSans-BoldItalic.otf

> Si ya tienen nombres distintos, documentarlo en `docs/02_nomenclatura.md`.
...
![Esperanza](source/img/logo.png  =250x250)
